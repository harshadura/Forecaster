 ...
 * {@link com.eclipsesource.json.JsonValue}).
 * <p>
 * Elements can be added using one of the different <code>add(...)</code> methods. Accepted values
 * are either instances of {@link com.eclipsesource.json.JsonValue}, or strings, primitive numbers, or boolean values.
 * </p>
 * <p>
 ...
 * </pre>
 * <p>
 * A n equivalent {@link java.util.List} can be obtained from the method {@link #values()}.
 * </p>
 * <p>
